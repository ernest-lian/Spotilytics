from backend.User.AnalyticsModel.AnalyticsDao.AnalyticsDao import AnalyticsDao
...
class AnalyticsModel:
    ...
    def store_analytics(user_id, sp, top_tracks):
        ...
        response['popular_track'] = AnalyticsModel.fetch_popular(sp)
        response['longest_track'] = analytics['longest_track']
        response['fastest_track'] = analytics['fastest_track']
        response['energetic_track'] = analytics['energetic_track']

        AnalyticsDao.create_connection(user_id, response)
